...
extension Defaults.Keys {
  ...
  static let copySound = Key<SoundEffect>("copySound", default: .write, suite: preferencesSuite)
  ...
  static let pasteSound = Key<SoundEffect>("pasteSound", default: .knock, suite: preferencesSuite)
